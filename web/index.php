   	...
   	<div class="contentContainer" id="topContainer">
   	    <div class="row">
   	        <div class="topRow col-md-6 col-md-offset-3">
   	            ...
   	            <h3 class="lead">I am currently working as a SmallTalk developer for JP Morgan but been learning different web technologies and am currently looking for a job as a web developer</h3>
